  ...
  return (
    <>
      <div className='home__data'> 
        <h1 className='home__title'>Mohammad Sohail Akhtar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>I'm passonate developer based in Kathmandu, and I am very dedicated to my work.</p>
